...
export default function AdminKategori() {
  ...
  const [kategori, setKategori] = useState([]); // Stores all kategori
  ...
  const [filteredData,setFilteredData]=useState([])
    ...
    const onAddNew = ()=>{
        router.push('/admin/kategori/form')
    }
    ...
    const goToDetail=(id)=>{
router.push(`/admin/kategori/detail/${id}`)
    }
            ...
            <table className="table-auto w-full">
                <thead>
                    <tr>
                        ...
                        <th className='table-head border-blue-gray-100'>Nama Kategori</th>
